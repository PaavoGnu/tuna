...
<?php echo $this->Form->create('StockMovimentItem');?>
	<fieldset>
 		<legend><?php __('Itens de Movimento de Estoque - Novo Item de Movimento de Estoque'); ?></legend>
	<?php
		echo $this->Form->input('stock_moviment_id', array('label' => 'Movimento de Estoque', 'type' => 'text', 'value' =>
			$stockMovimentId, 'readonly' => true));
