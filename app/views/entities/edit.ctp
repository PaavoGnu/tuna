...
<?php echo $this->Form->create('Entity');?>
	<fieldset>
 		<legend><?php __('Entidades - Editar'); ?></legend>
	<?php
		echo $this->Form->input('entity_type_id', array('label' => 'Tipo'));
		echo $this->Form->input('entity_name', array('label' => 'Nome'));
		echo $this->Form->input('entity_real_name', array('label' => 'Nome Completo'));
		echo $this->Form->input('entity_birth_date', array('label' => 'Data de Nascimento', 'empty' => '-', 'dateFormat' => 'DMY', 'minYear' => '1900'));
