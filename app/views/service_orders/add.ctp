...
<?php echo $this->Form->create('ServiceOrder');?>
	...
	<?php
		...
		$this->Js->event('change', $this->Js->request(array('controller' => 'service_orders', 'action' => 'getEntity', '$("#ServiceOrderEntityGroupId").serialize()'),
			array('async' => true, 'method' => 'POST', 'dataExpression' => true, 'data' => '$("#ServiceOrderEntityGroupId").serialize()', 
