...
<?php echo $this->Form->create('StockItem');?>
	<fieldset>
 		<legend><?php __('Edit Stock Item'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('StockItem.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('StockItem.id'))); ?></li>
